...
describe('recurring task expansion', () => {
  ...
  it('collapses a recurring series to the current occurrence for management lists', () => {
    const expanded = expandRecurringTasks([task], [], '2026-08-10', '2026-08-14', 'Asia/Bangkok')
