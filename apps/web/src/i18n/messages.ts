export const messages = {
  th: {
    ...
    'calendar.title': 'ปฏิทิน', 'calendar.detail': 'เห็นภาระ เวลาโฟกัส และพื้นที่ว่างในสัปดาห์เดียว',
  ...
  en: {
    ...
    'calendar.title': 'Calendar', 'calendar.detail': 'See commitments, focus time, and open space in one week.',
